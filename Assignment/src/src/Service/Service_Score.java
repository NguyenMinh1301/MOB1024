    ...
    public boolean addCheck(String idStudent, String name, String english, String computer, String physical) {
        ...
        try {
            ...
            try {
                ...
                DAO_Notification.announceWarning("<html>English score must be a <b>number</b></html>");
                return b;
            }
            ...
            try {
                ...
                DAO_Notification.announceWarning("<html>Computer score must be a <b>number</b></html>");
                return b;
            }
            ...
            try {
                ...
                DAO_Notification.announceWarning("<html>Physical score must be a <b>number</b></html>");
                return b;
            }

            if (englishFloat < 0 || englishFloat > 10) {
                DAO_Notification.announceWarning("<html>English score must be <b>between 1 - 10</b></html>");
                return b;
            }

            if (computerFloat < 0 || computerFloat > 10) {
                DAO_Notification.announceWarning("<html>Computer score must be <b>between 1 - 10</b></html>");
                return b;
            }

            if (physicalFloat < 0 || physicalFloat > 10) {
                DAO_Notification.announceWarning("<html>Physical score must be <b>between 1 - 10</b></html>");
                return b;
            }
