...
public class SupScreen_UpdateScore extends javax.swing.JFrame {

    private View_Score scorePanel;

    public SupScreen_UpdateScore(String idStudent, String name, String english, String computer, String physical, View_Score scorePanel) {
